...
public class UserController {
  ...
  public static void userRegistration() {
    ...
    LoggerService.addMessage(message, UserService.getUser(username));
    userLogin();
  }
  ...
  public static void userLogin() {
    ...
    LoggerService.addMessage("Произведен вход в систему.");
  ...
  public static void logout() {
    LoggerService.addMessage("Вы успешно вышли из системы!");
