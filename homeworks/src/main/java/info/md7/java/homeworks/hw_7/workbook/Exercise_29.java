...
public class Exercise_29 {
  ...
  public static void main(String[] args) {
    String text = "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. "
        ...
        + " augue velit cursus nunc, Lorem ipsum dolor sit amet, consectetuer adipiscing elit."
        + " Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et"
        + " magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies"
        + " nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim."
    ...
    for (String word : splittedText) {
      wordsFrequencyMap.compute(word, (k, v) -> v == null ? 1 : v + 1);
    }
    wordsFrequencyMap.forEach(
        (key, value) -> System.out.println("Слово: " + key + " | " + "Кол-во: " + value));
